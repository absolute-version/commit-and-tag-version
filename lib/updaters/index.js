...
import * as json from './types/json.js';
import * as plainText from './types/plain-text.js';
import * as maven from './types/maven.js';
import * as gradle from './types/gradle.js';
import * as csproj from './types/csproj.js';
import * as yaml from './types/yaml.js';
import * as openapi from './types/openapi.js';
import * as python from './types/python.js';
